    ...
    <div class="container">
        <div class="card bg-light mb-4">
            <div class="card-body">
                ...
                <p class="mt-4">
                    Dear Instructor, you are now logged into the Online Examination System (OES). This platform enables you to effectively manage all examination-related activities, including the creation, scheduling, and grading of exams for your students.
                </p>
